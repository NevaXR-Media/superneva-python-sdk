...
class SNPrompts(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> PromptList:
...
class SNTargets(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> TargetList:
...
class SNReactions(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> ReactionList:
...
class SNMetas(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> MetaList:
...
class SNLogs(SNRequest):
    ...
    def create(self, data: Optional["str"], _auth: Optional[Auth] = None) -> SimpleResponse:
...
class SNInterests(SNRequest):
    ...
    def create(self, data: Optional["str"], cleanCache: Optional["str"], _auth: Optional[Auth] = None) -> Interest:
...
class SNInfo(SNRequest):
    ...
    def get(self, locale: Optional["str"], clientType: Optional["str"], clientVersion: Optional["str"], _auth: Optional[Auth] = None) -> Info:
...
class SNFiles(SNRequest):
    ...
    def upload(self, data: Optional["str"], contentType: Optional["str"], filename: Optional["str"], path: Optional["str"], key: Optional["str"], _auth: Optional[Auth] = None) -> File:
...
class SNContents(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> ContentList:
...
class SNCollections(SNRequest):
    ...
    def get(self, collectionId: Optional["str"], _auth: Optional[Auth] = None) -> Collection:
        return self.request(f"/collections/{collectionId}", body={}, _auth=_auth)  # type: ignore

    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> CollectionList:
...
class SNAuth(SNRequest):
    ...
    def loginWithToken(self, token: Optional["str"], _auth: Optional[Auth] = None) -> Session:
        return self.request("/auth/login-with-token", body={ "token": token }, _auth=_auth)  # type: ignore

    def connectWithService(self, data: Optional["str"], service: Optional["str"], targetId: Optional["str"], targetKey: Optional["str"], _auth: Optional[Auth] = None) -> Session:
    ...
    def createAccount(self, email: Optional["str"], password: Optional["str"], profile: Optional["str"], settings: Optional["str"], targetId: Optional["str"], targetKey: Optional["str"], _auth: Optional[Auth] = None) -> Session:
...
class SNAccountsMeCollections(SNRequest):
    ...
    def delete(self, collectionId: Optional["str"], _auth: Optional[Auth] = None) -> SimpleResponse:
        return self.request(f"/accounts/me/collections/delete/{collectionId}", body={}, _auth=_auth)  # type: ignore

    def update(self, collectionId: Optional["str"], data: Optional["str"], _auth: Optional[Auth] = None) -> Collection:
        return self.request("/accounts/me/collections/update", body={ "collectionId": collectionId, "data": data }, _auth=_auth)  # type: ignore

    def removeContentFromCollection(self, collectionId: Optional["str"], contentId: Optional["str"], _auth: Optional[Auth] = None) -> Collection:
    ...
    def addContentToCollection(self, collectionId: Optional["str"], contentId: Optional["str"], _auth: Optional[Auth] = None) -> Collection:
...
class SNAccountsMeContents(SNRequest):
    ...
    def delete(self, contentId: Optional["str"], _auth: Optional[Auth] = None) -> SimpleResponse:
        return self.request(f"/accounts/me/contents/delete/{contentId}", body={}, _auth=_auth)  # type: ignore

    def update(self, contentId: Optional["str"], data: Optional["str"], _auth: Optional[Auth] = None) -> Content:
...
class SNAccountsMeDevices(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> DeviceList:
    ...
    def update(self, deviceId: Optional["str"], data: Optional["str"], _auth: Optional[Auth] = None) -> Device:
        return self.request("/accounts/me/devices/update", body={ "deviceId": deviceId, "data": data }, _auth=_auth)  # type: ignore

    def delete(self, deviceId: Optional["str"], _auth: Optional[Auth] = None) -> SimpleResponse:
...
class SNAccountsMeInterests(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> InterestList:
    ...
    def get(self, interestId: Optional["str"], _auth: Optional[Auth] = None) -> Interest:
    ...
    def delete(self, interestId: Optional["str"], _auth: Optional[Auth] = None) -> SimpleResponse:
...
class SNAccountsMeLocations(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> LocationList:
    ...
    def deleteAll(self, deviceId: Optional["str"], _auth: Optional[Auth] = None) -> SimpleResponse:
...
class SNAccountsMeLogs(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> LogList:
...
class SNAccountsMePrompts(SNRequest):
    ...
    def update(self, promptId: Optional["str"], data: Optional["str"], _auth: Optional[Auth] = None) -> Prompt:
        return self.request("/accounts/me/prompts/update", body={ "promptId": promptId, "data": data }, _auth=_auth)  # type: ignore

    def delete(self, promptId: Optional["str"], _auth: Optional[Auth] = None) -> SimpleResponse:
...
class SNAccountsMeReactions(SNRequest):
    ...
    def save(self, data: Optional["str"], skipNotification: Optional["str"], _auth: Optional[Auth] = None) -> Reaction:
...
class SNAccountsMeStates(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["str"], skip: Optional["str"], sort: Optional["str"], filters: Optional["str"], _auth: Optional[Auth] = None) -> StateList:
