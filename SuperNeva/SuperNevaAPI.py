...
class SNPrompts(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["PromptListSortInput"]], filters: Optional["PromptListFilterInput"], _auth: Optional[Auth] = None) -> PromptList:
        return self.request("/prompts", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
...
class SNTargets(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["TargetListSortInput"]], filters: Optional["TargetListFilterInput"], _auth: Optional[Auth] = None) -> TargetList:
        return self.request("/targets", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
...
class SNReactions(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["ReactionListSortInput"]], filters: Optional["ReactionListFilterInput"], _auth: Optional[Auth] = None) -> ReactionList:
        return self.request("/reactions", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
...
class SNMetas(SNRequest):
    ...
    def create(self, data: List["MetaInput"], _auth: Optional[Auth] = None) -> MetaList:
        return self.request("/metas/create", body=cleanup_dict({ "data": data }), auth=_auth)
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["MetaListSortInput"]], filters: Optional["MetaListFilterInput"], _auth: Optional[Auth] = None) -> MetaList:
        return self.request("/metas", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
...
class SNLogs(SNRequest):
    ...
    def create(self, data: List["LogInput"], _auth: Optional[Auth] = None) -> SimpleResponse:
        return self.request("/logs/create", body=cleanup_dict({ "data": data }), auth=_auth)
...
class SNInterests(SNRequest):
    ...
    def create(self, data: "InterestInput", cleanCache: Optional["bool"], _auth: Optional[Auth] = None) -> Interest:
        return self.request("/interests/create", body=cleanup_dict({ "data": data, "cleanCache": cleanCache }), auth=_auth)
...
class SNInfo(SNRequest):
    ...
    def get(self, locale: Optional["Locale"], clientType: Optional["str"], clientVersion: Optional["str"], _auth: Optional[Auth] = None) -> Info:
        return self.request("/info", body=cleanup_dict({ "locale": locale, "clientType": clientType, "clientVersion": clientVersion }), auth=_auth)
...
class SNFiles(SNRequest):
    ...
    def upload(self, data: "str", contentType: "str", filename: Optional["str"], path: Optional["str"], key: Optional["str"], _auth: Optional[Auth] = None) -> File:
        return self.request("/files/upload", body=cleanup_dict({ "data": data, "contentType": contentType, "filename": filename, "path": path, "key": key }), auth=_auth)
...
class SNContents(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["ContentListSortInput"]], filters: Optional["ContentListFilterInput"], _auth: Optional[Auth] = None) -> ContentList:
        return self.request("/contents", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
...
class SNCollections(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["CollectionListSortInput"]], filters: Optional["CollectionListFilterInput"], _auth: Optional[Auth] = None) -> CollectionList:
        return self.request("/collections", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
...
class SNAuth(SNRequest):
    ...
    def loginWithToken(self, token: "str", _auth: Optional[Auth] = None) -> Session:
        return self.request("/auth/login-with-token", body=cleanup_dict({ "token": token }), auth=_auth)
    ...
    def connectWithService(self, data: Optional["Any"], service: "ServiceInput", targetId: Optional["str"], targetKey: Optional["str"], _auth: Optional[Auth] = None) -> Session:
        return self.request("/auth/connect-with-service", body=cleanup_dict({ "data": data, "service": service, "targetId": targetId, "targetKey": targetKey }), auth=_auth)
    ...
    def createAccount(self, email: "str", password: "str", profile: Optional["AccountProfileInput"], settings: Optional["AccountSettingsInput"], targetId: Optional["str"], targetKey: Optional["str"], _auth: Optional[Auth] = None) -> Session:
        return self.request("/auth/create-account", body=cleanup_dict({ "email": email, "password": password, "profile": profile, "settings": settings, "targetId": targetId, "targetKey": targetKey }), auth=_auth)
...
class SNAccountsMeCollections(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["CollectionListSortInput"]], filters: Optional["CollectionListFilterInput"], _auth: Optional[Auth] = None) -> CollectionList:
        return self.request("/accounts/me/collections", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)

    def create(self, data: "CollectionInput", _auth: Optional[Auth] = None) -> Collection:
        return self.request("/accounts/me/collections/create", body=cleanup_dict({ "data": data }), auth=_auth)
    ...
    def update(self, collectionId: "str", data: "CollectionInput", _auth: Optional[Auth] = None) -> Collection:
        return self.request("/accounts/me/collections/update", body=cleanup_dict({ "collectionId": collectionId, "data": data }), auth=_auth)

    def removeContentFromCollection(self, collectionId: "str", contentId: "str", _auth: Optional[Auth] = None) -> Collection:
        return self.request("/accounts/me/collections/remove-content-from-collection", body=cleanup_dict({ "collectionId": collectionId, "contentId": contentId }), auth=_auth)

    def addContentToCollection(self, collectionId: "str", contentId: "str", _auth: Optional[Auth] = None) -> Collection:
        return self.request("/api/v1/accounts/me/collections/add-content-to-collection", body=cleanup_dict({ "collectionId": collectionId, "contentId": contentId }), auth=_auth)
...
class SNAccountsMeContents(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["ContentListSortInput"]], filters: Optional["ContentListFilterInput"], _auth: Optional[Auth] = None) -> ContentList:
        return self.request("/accounts/me/contents", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)

    def create(self, data: "ContentInput", _auth: Optional[Auth] = None) -> Content:
        return self.request("/accounts/me/contents/create", body=cleanup_dict({ "data": data }), auth=_auth)
    ...
    def update(self, contentId: "str", data: "ContentInput", _auth: Optional[Auth] = None) -> Content:
        return self.request("/accounts/me/contents/update", body=cleanup_dict({ "contentId": contentId, "data": data }), auth=_auth)
...
class SNAccountsMeDevices(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["DeviceListSortInput"]], filters: Optional["DeviceListFilterInput"], _auth: Optional[Auth] = None) -> DeviceList:
        return self.request("/accounts/me/devices", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)

    def save(self, data: "DeviceInput", _auth: Optional[Auth] = None) -> Device:
        return self.request("/accounts/me/devices/save", body=cleanup_dict({ "data": data }), auth=_auth)

    def update(self, deviceId: "str", data: "DeviceInput", _auth: Optional[Auth] = None) -> Device:
        return self.request("/accounts/me/devices/update", body=cleanup_dict({ "deviceId": deviceId, "data": data }), auth=_auth)
...
class SNAccountsMeInterests(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["InterestListSortInput"]], filters: Optional["InterestListFilterInput"], _auth: Optional[Auth] = None) -> InterestList:
        return self.request("/accounts/me/interests", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
    ...
    def create(self, data: "InterestInput", cleanCache: Optional["bool"], _auth: Optional[Auth] = None) -> Interest:
        return self.request("/accounts/me/interests/create", body=cleanup_dict({ "data": data, "cleanCache": cleanCache }), auth=_auth)
...
class SNAccountsMeLocations(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["LocationListSortInput"]], filters: Optional["LocationListFilterInput"], _auth: Optional[Auth] = None) -> LocationList:
        return self.request("/accounts/me/locations", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)

    def register(self, data: "LocationInput", _auth: Optional[Auth] = None) -> Location:
        return self.request("/accounts/me/locations/register", body=cleanup_dict({ "data": data }), auth=_auth)

    def deleteAll(self, deviceId: "str", _auth: Optional[Auth] = None) -> SimpleResponse:
        return self.request("/accounts/me/locations/delete-all", body=cleanup_dict({ "deviceId": deviceId }), auth=_auth)
...
class SNAccountsMeLogs(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["LogListSortInput"]], filters: Optional["LogListFilterInput"], _auth: Optional[Auth] = None) -> LogList:
        return self.request("/accounts/me/logs", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)

    def create(self, data: List["LogInput"], _auth: Optional[Auth] = None) -> SimpleResponse:
        return self.request("/accounts/me/logs/create", body=cleanup_dict({ "data": data }), auth=_auth)
...
class SNAccountsMePrompts(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["PromptListSortInput"]], filters: Optional["PromptListFilterInput"], _auth: Optional[Auth] = None) -> PromptList:
        return self.request("/accounts/me/prompts", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
    ...
    def create(self, data: "PromptInput", _auth: Optional[Auth] = None) -> Prompt:
        return self.request("/accounts/me/prompts/create", body=cleanup_dict({ "data": data }), auth=_auth)

    def update(self, promptId: "str", data: "PromptInput", _auth: Optional[Auth] = None) -> Prompt:
        return self.request("/accounts/me/prompts/update", body=cleanup_dict({ "promptId": promptId, "data": data }), auth=_auth)
...
class SNAccountsMeReactions(SNRequest):
    ...
    def save(self, data: "ReactionInput", skipNotification: Optional["bool"], _auth: Optional[Auth] = None) -> Reaction:
        return self.request("/accounts/me/reactions/save", body=cleanup_dict({ "data": data, "skipNotification": skipNotification }), auth=_auth)
...
class SNAccountsMeStates(SNRequest):
    ...
    def list(self, _id: Optional["str"], limit: Optional["int"], skip: Optional["int"], sort: Optional[List["StateListSortInput"]], filters: Optional["StateListFilterInput"], _auth: Optional[Auth] = None) -> StateList:
        return self.request("/accounts/me/states", body=cleanup_dict({ "_id": _id, "limit": limit, "skip": skip, "sort": sort, "filters": filters }), auth=_auth)
    ...
    def save(self, data: "StateInput", _auth: Optional[Auth] = None) -> State:
        return self.request("/accounts/me/states/save", body=cleanup_dict({ "data": data }), auth=_auth)
